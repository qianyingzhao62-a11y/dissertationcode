...
Reproduces all 7 figures in "Model and Calibration-Window Risk in UK Longevity" from the raw HMD GBR_NP files.
...
# Usage: 
place this file in the same directory as GBR_data/ and run it section by section (RStudio: Ctrl+Enter). Part 0 must be run first;
